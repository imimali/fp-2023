from seminar5.business import add_student, modify_student, register_for_undo, pop_undo_list
    ...
    while True:
        try:
            ...
            if command == '1':
                ...
                register_for_undo(undo_list, students)
                print("You will be asked to enter the data of the student to be modified")
                id_student, name, group, spec = read_student_data()
